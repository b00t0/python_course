"""
Написать EDA (разведочный анализ данных) для датасета про пингвинов Необходимо:
...
#● Применить доп измерение в точечных графиках, используя аргументы hue, size, style
